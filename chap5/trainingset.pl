...
#########################################
## This program (written halfway between Hallowe'en and Thanksgiving)
## constructs a set of alignments between homologous (black) cat and turkey
## proteins.  The alignments can then be used as inputs to buildpam.pl.
## The subroutines are the same as in Chapter 3's similarity.pl.
## The main program uses sequence-reader routines from Chapter 6.
#########################################
